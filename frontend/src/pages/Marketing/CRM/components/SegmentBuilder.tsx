...
const leadSegmentFields: SegmentFieldDefinition[] = [
  ...
  { value: "address", label: "Address / Legacy Address", group: "Basic Lead Info", type: "text", operators: ["equals", "not_equals", "contains", "not_contains", "starts_with", "ends_with", "is_empty", "is_not_empty", "in", "not_in"], helperText: "Useful for older imported leads where city/state/country were not split yet." },
...
const fallbackFields: SegmentFieldDefinition[] = [
  ...
  { value: "companyName", label: "Company Name", group: "Basic Lead Info", type: "text", operators: ["equals", "contains"] },
  { value: "address", label: "Address / Legacy Address", group: "Basic Lead Info", type: "text", operators: ["equals", "contains", "is_empty", "is_not_empty"] },
  { value: "country", label: "Country", group: "Basic Lead Info", type: "text", operators: ["equals", "contains", "is_empty", "is_not_empty"] },
  { value: "city", label: "City", group: "Basic Lead Info", type: "text", operators: ["equals", "contains", "is_empty", "is_not_empty"] },
  { value: "state", label: "State", group: "Basic Lead Info", type: "text", operators: ["equals", "contains", "is_empty", "is_not_empty"] },
  { value: "createdAt", label: "Created At", group: "Basic Lead Info", type: "date", operators: ["before", "after", "on", "between", "is_empty", "is_not_empty"] },
