...
const BATCH_LABEL = "software-batch43";
const LOGO_TEMP_DIR = path.resolve(EXPORTS_DIR, "tmp-software-batch43-logos");
const SHOPIFY_GRAPHQL_PAGE_SIZE = 100;
const TARGET_CATEGORY_SLUG = "software";
const PREVIEW_FILE_PREFIX = "software-batch43-preview-";
