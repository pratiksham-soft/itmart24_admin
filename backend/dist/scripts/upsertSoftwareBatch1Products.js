...
const BATCH_LABEL = "software-batch1";
const LOGO_TEMP_DIR = path.resolve(EXPORTS_DIR, "tmp-software-batch1-logos");
const SHOPIFY_GRAPHQL_PAGE_SIZE = 100;
const TARGET_CATEGORY_SLUG = "software";
const PREVIEW_FILE_PREFIX = "software-batch1-preview-";
